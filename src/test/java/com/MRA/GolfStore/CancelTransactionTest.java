...
public class CancelTransactionTest extends BasePage {
	...
	public void cancelTransactionTest(Map<String, String> testCaseData) throws Exception{
        ...
        if (vAPI.mapsAreEqual(result.getExpectedMap(),result.getActualMap())){
            ...
            extenttest.log(LogStatus.PASS, "CancelTransactionTest Pass",detailReport);}
    	      
    		else{
    			
    			Reporter.log("TestCase Fail");
            
            extenttest.log(LogStatus.FAIL, "CancelTransactionTest Fail",detailReport);
