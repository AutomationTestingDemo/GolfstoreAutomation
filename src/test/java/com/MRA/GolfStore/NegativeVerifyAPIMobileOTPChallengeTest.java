...
public class NegativeVerifyAPIMobileOTPChallengeTest extends BasePage{
	
	
	@Test (dataProvider="cardNumProvider")
	public void negativeVerifyAPImobileotpChallengeTest(Map<String, String> testCaseData) throws Exception{
