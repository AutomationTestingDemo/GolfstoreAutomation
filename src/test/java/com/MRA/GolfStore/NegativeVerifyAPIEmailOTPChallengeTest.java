...
public class NegativeVerifyAPIEmailOTPChallengeTest extends BasePage {
	@Test (dataProvider="cardNumProvider")
	public void negativeVerifyAPIemailotpChallengeTest(Map<String, String> testCaseData) throws Exception{
